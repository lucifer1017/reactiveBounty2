...
export function DepositForm() {
  // Deposit flow: mint test WETH → approve vault → deposit to start 5-loop automation.
  ...
  // ABI types come from JSON, so we narrow before using `formatUnits`.
          ...
          <div className="relative group px-2 py-4">
            ...
            <div className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 rounded-3xl p-2 border-2 border-purple-500/30">
              ...
              <button
                ...
                disabled={isLoading}
                className="absolute right-6 top-1/2 -translate-y-1/2 px-6 py-3 bg-gradient-to-r from-purple-500 via-purple-600 to-pink-500 hover:from-purple-400 hover:via-purple-500 hover:to-pink-400 rounded-xl text-base font-bold text-white transition-all shadow-xl shadow-purple-500/40 hover:shadow-purple-500/60 hover:scale-105 cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed active:scale-95"
              >
                MAX
              </button>
            </div>
        ...
        <div className="px-2 py-4">
          {balanceNum < parseFloat(amount || '0') ? (
            <motion.button
              ...
              onClick={handleMint}
              disabled={isLoading}
              className="relative w-full py-6 bg-gradient-to-r from-purple-600 via-purple-500 to-pink-600 hover:from-purple-500 hover:via-purple-400 hover:to-pink-500 rounded-2xl text-white font-bold text-xl shadow-[0_10px_40px_rgba(168,85,247,0.5)] hover:shadow-[0_20px_60px_rgba(168,85,247,0.6)] cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 overflow-hidden border-2 border-purple-400/40"
            >
            ...
            <motion.button
              ...
              disabled={isLoading}
              className="relative w-full py-6 bg-gradient-to-r from-blue-600 via-cyan-500 to-purple-600 hover:from-blue-500 hover:via-cyan-400 hover:to-purple-500 rounded-2xl text-white font-bold text-xl shadow-[0_10px_40px_rgba(59,130,246,0.5)] hover:shadow-[0_20px_60px_rgba(59,130,246,0.6)] cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 overflow-hidden border-2 border-blue-400/40"
            >
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent translate-x-[-200%] group-hover:translate-x-[200%] transition-transform duration-1000"></div>
              <div className="relative">
                {isApprovePending ? (
            ...
            <motion.button
              ...
              disabled={isLoading}
              className="relative w-full py-6 bg-gradient-to-r from-green-600 via-emerald-500 to-teal-600 hover:from-green-500 hover:via-emerald-400 hover:to-teal-500 rounded-2xl text-white font-bold text-xl shadow-[0_10px_40px_rgba(16,185,129,0.5)] hover:shadow-[0_20px_60px_rgba(16,185,129,0.6)] cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 overflow-hidden border-2 border-green-400/40"
            >
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/20 to-transparent translate-x-[-200%] group-hover:translate-x-[200%] transition-transform duration-1000"></div>
              <div className="relative">
                {isDepositPending ? (
